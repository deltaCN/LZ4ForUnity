...
public static class LZ4Tool
{
    ...
    [MenuItem("Assets/LZ4/DecompressToLZ4", false, 110)]
    public static void DecompressLZ4()
    {
        ...
        foreach (string guid in GUIDs)
        {
            ...
            DirectoryInfo info = Directory.CreateDirectory(Path.Combine(Directory.GetParent(assetPath).FullName, extractDirectorName));
